...
export const dayState = sqliteTable("day_state", {
  ...
  priorStayMinutes: integer("prior_stay_minutes").notNull().default(6),
  normalCapacity: integer("normal_capacity").notNull().default(17),
  ...
  priorStaySeconds: integer("prior_stay_seconds").notNull().default(360),
